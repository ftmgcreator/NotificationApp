...
export default function SettingsScreen() {
    ...
    const refresh = useCallback(async () => {
        ...
        for (const p of PERMS) {
            updated[p.key] = await checkPerm(p.permission);
        }
        setStatuses(updated);
    }, []);
        ...
        <View style={styles.root}>
            ...
            <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.content}>
                ...
                <View style={styles.section}>
                    ...
                    <View style={styles.group}>
                        {PERMS.map((p, i) => (
                            <View key={p.key}>
                                <PermRow
                                    label={p.label} hint={p.hint} icon={p.icon}
                ...
                <View style={styles.section}>
                    ...
                    <View style={styles.group}>
                        <DefaultRow label="Telefon ilovasi" hint="Standart qo\'ng\'iroq ilovasi" icon="call" status={dialerStatus} onPress={requestDefaultDialer} />
                        <View style={styles.divider} />
                        <DefaultRow label="SMS ilovasi" hint="Standart xabar ilovasi" icon="chatbubble" status={smsStatus} onPress={requestDefaultSms} />
                    </View>
                </View>
